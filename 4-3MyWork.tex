...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[scale=1.0]{2energyBarPic.jpg}
...
\subsubsection{Database and web server to access data} 
...
\iffalse The following solution was implemented for instance with a headache animation and also a bizarre overreaction to hypoglycemia, the avatar beahaving as if it was happy or angry.\\
...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[scale=1.0]{7eatingPic.jpg}
...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[scale=1.0]{11insulinObject.jpg}
...
\begin{figure}[h]
  ...
  \centering
  \includegraphics[scale=1.0]{17fishingAnimationWrong.jpg}
